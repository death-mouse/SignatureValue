...
{
    /// <summary>
    /// Сводное описание для GETServiceDeskAPI
    /// </summary>
    [WebService(Namespace = "http://tempuri.org/")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    [System.ComponentModel.ToolboxItem(false)]

    public class GETServiceDeskAPI : System.Web.Services.WebService
    {

        [WebMethod]
        public string GetServiceDeskAPI()
        {
            string textResult = "";
            ...
            var request = new RestRequest(textResult, Method.GET);
